	...
	public static void main(String[] args) {
		...
		for(BD1Block block:blocks) {
			...
			for(int i=0;i<vertex_positions.length;i++) {
				...
				if(sign_x==0)scale_x=1.0f+offset_x;
				else scale_x=1.0f-offset_x;
				if(sign_y==0)scale_y=1.0f+offset_y;
				else scale_y=1.0f-offset_y;
				if(sign_z==0)scale_z=1.0f+offset_z;
				else scale_z=1.0f-offset_z;
