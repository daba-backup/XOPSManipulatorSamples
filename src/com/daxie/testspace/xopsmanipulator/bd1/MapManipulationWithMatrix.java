...
public class MapManipulationWithMatrix {
	public static void main(String[] args) {
		...
		//Make matrices.
		Matrix rot_x = MatrixFunctions.MGetRotX(MathFunctions.DegToRad(30.0f));//Rotate 30 degrees around x-axis
        Matrix rot_y = MatrixFunctions.MGetRotY(MathFunctions.DegToRad(60.0f));//Rotate 60 degrees around y-axis
        Matrix rot_z = MatrixFunctions.MGetRotZ(MathFunctions.DegToRad(45.0f));//Rotate 45 degrees around z-axis
        Matrix translate = MatrixFunctions.MGetTranslate(VectorFunctions.VGet(0.0f, 400.0f, 0.0f));//Translate +400 coordinates along y-axis
